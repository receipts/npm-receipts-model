const LotteryResultsCollectionResponse = function LotteryResultsCollectionResponse(total, results) {
  this.total = total;
  this.results = results;
};

const LotteryResultsCollectionResponseBuilder = function LotteryResultsCollectionResponseBuilder() {
  this.total = null;
  this.results = null;
