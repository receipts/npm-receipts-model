var LotteryTicketsCollectionResponse = function LotteryTicketsCollectionResponse(total, tickets) {
  this.total = total;
  this.tickets = tickets;
};

var LotteryTicketsCollectionResponseBuilder = function LotteryTicketsCollectionResponseBuilder() {
  this.total = null;
  this.tickets = null;
