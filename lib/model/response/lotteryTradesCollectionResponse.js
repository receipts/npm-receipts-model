const LotteryTradesCollectionResponse = function LotteryTradesCollectionResponse(total, trades) {
  this.total = total;
  this.trades = trades;
};

const LotteryTradesCollectionResponseBuilder = function LotteryTradesCollectionResponseBuilder() {
  this.total = null;
  this.trades = null;
